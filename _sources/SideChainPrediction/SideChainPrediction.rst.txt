...
By default, a final relaxation minimization is executed at the end of the side chain prediction phase in a PELE simulation, but this is configured in the ``"Minimizer"`` section of such command (see :ref:`sec-minimization`). This behaviour can be changed with the flag skipGlobalMinimization.
